...
##### FROM FILES
tedx_dataset_path = "s3://unibg-tedx-data-project/tedx_dataset.csv"
...
## READ TAGS DATASET
tags_dataset_path = "s3://unibg-tedx-data-project/tags_dataset.csv"
...
mongo_uri = "mongodb://mycluster-shard-00-00-gacwu.mongodb.net:27017,mycluster-shard-00-01-gacwu.mongodb.net:27017,mycluster-shard-00-02-gacwu.mongodb.net:27017"
